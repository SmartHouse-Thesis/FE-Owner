        ...
        <Document>
          <Page size='A4' style={styles.page}>
            <View style={styles.sectionTop}>
              ...
              <Text style={styles.textContract}> Hợp đồng lắp đặt thiết bị thông minh</Text>
            ...
            <View>
              ...
              <Text style={styles.textBold}>
                BÊN B (Bên nhận khoán): CÔNG TY Phát Đạt
              </Text>
              <Text style={styles.textRegular}>
                Đại diện: {contract?.staff.fullName} Chức vụ: Nhân viên
              </Text>
              <Text style={styles.textRegular}>
                Mã số thuế: ……………BA7812312948012839012803…
              </Text>
              <Text style={styles.textRegular}>
                Địa chỉ: …01 Lý Thường Kiệt Quận 1 Thành phố Hồ Chí Minh………….
              </Text>
              ...
              <Text style={styles.textRegular}>
                Bên B nhận lắp đặt thiết bị theo quy cách và số lượng cụ thể như
                sau:
              </Text>
              ...
              <Text style={styles.textRegular}>
                - Thanh toán đầy đủ số tiền đã ký hợp đồng khi nhà thầu bàn giao
                cho bên A
              </Text>
              ...
              <Text style={styles.textRegular}>
                - Hai bên cam kết thực hiện đúng như Hợp đồng đã ký. Trong thời
                gian thực hiện hợp đồng, trong quá trình thực hiện nếu có những
                vướng mắc hai bên sẽ gặp nhau cùng nhau bàn bạc giải quyết như
                cơ sở thương lượng.
              </Text>
              <Text style={styles.textRegular}>
              ...
              <Text style={styles.textRegular}>
                - Hợp đồng gồm … trang và được lập thành 02 bản, mỗi bên giữ 01
